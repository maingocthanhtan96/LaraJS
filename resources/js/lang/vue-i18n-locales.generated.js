export default {
  ...
  ja: {
    ...
    validation: {
      ...
      alpha_dash:
        "{attribute}には、英数字('A-Z','a-z','0-9')とハイフンと下線('-','_')が使用できます。",
      ...
      between: {
        numeric:
          '{attribute}には、{min}から、{max}までの数字を指定してください。',
        file:
          '{attribute}には、{min} KBから{max} KBまでのサイズのファイルを指定してください。',
      ...
      ends_with:
        '{attribute}は、次のうちのいずれかで終わらなければなりません。: {values}',
      ...
      mimetypes:
        '{attribute}には、{values}タイプのファイルを指定してください。',
      min: {
      ...
      required_unless:
        '{other}が{values}以外の場合、{attribute}を指定してください。',
      required_with:
        '{values}が指定されている場合、{attribute}も指定してください。',
      required_with_all:
        '{values}が全て指定されている場合、{attribute}も指定してください。',
      required_without:
        '{values}が指定されていない場合、{attribute}を指定してください。',
      required_without_all:
        '{values}が全て指定されていない場合、{attribute}を指定してください。',
      ...
      starts_with:
        '{attribute}は、次のいずれかで始まる必要があります。{values}',
