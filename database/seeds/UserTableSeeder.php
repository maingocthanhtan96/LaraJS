...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $creatorRole->givePermissionTo([\ACL::PERMISSION_VISIT, \ACL::PERMISSION_CREATE]);
        $editorRole->givePermissionTo([\ACL::PERMISSION_VISIT, \ACL::PERMISSION_CREATE, \ACL::PERMISSION_EDIT]);
        $deleterRole->givePermissionTo([\ACL::PERMISSION_VISIT, \ACL::PERMISSION_DELETE]);
