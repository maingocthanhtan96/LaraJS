...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        try {
            ...
            } else if ($response->getCode() === Response::HTTP_BAD_REQUEST) {
                return $this->jsonError(trans('auth.login_fail'), $response->getCode());
            } else if ($response->getCode() === Response::HTTP_UNAUTHORIZED) {
                return $this->jsonError(trans('auth.credentials_incorrect'), $response->getCode());
            }
        } catch (\Exception $e) {
            writeLogException($e);
