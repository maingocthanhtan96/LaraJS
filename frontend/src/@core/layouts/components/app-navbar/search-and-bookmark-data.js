...
export default {
    ...
    data: [
      {
        file_name: "Joe's CV",
        from: 'Stacy Watson',
        icon: require('@/assets/images/icons/doc.png').default,
        size: '1.7 mb',
      },
      {
        file_name: 'Passport Image',
        from: 'Ben Sinitiere',
        icon: require('@/assets/images/icons/jpg.png').default,
        size: ' 52 kb',
      },
      {
        file_name: 'Questions',
      ...
      },
      {
        ...
        from: 'Tom Alred',
        icon: require('@/assets/images/icons/xls.png').default,
        size: '52 mb',
      },
      {
      ...
      },
      {
        ...
        icon: require('@/assets/images/icons/pdf.png').default,
        size: '7.2 mb',
      },
      {
  ...
  contacts: {
    ...
    data: [
      {
        img: require('@/assets/images/portrait/small/avatar-s-4.jpg').default,
        name: 'Rena Brant',
        email: 'nephrod@preany.co.uk',
        time: '21/05/2019',
      },
      {
        img: require('@/assets/images/portrait/small/avatar-s-2.jpg').default,
        name: 'Mariano Packard',
        email: 'seek@sparaxis.org',
        time: '14/01/2018',
      },
      {
        img: require('@/assets/images/portrait/small/avatar-s-24.jpg').default,
        name: 'Risa Montufar',
      ...
      {
        img: require('@/assets/images/portrait/small/avatar-s-25.jpg').default,
        name: 'Abbey Darden',
      ...
      {
        img: require('@/assets/images/portrait/small/avatar-s-23.jpg').default,
        name: 'Shellie Muster',
