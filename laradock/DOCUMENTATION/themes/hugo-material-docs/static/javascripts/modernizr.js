!(function(e, t, n) {
        ...
        for (i = r(t.fn, 'function') ? t.fn() : t.fn, o = 0; o < e.length; o++)
          (a = e[o]),
            ...
            1 === s.length
              ? (S[s[0]] = i)
              : (!S[s[0]] ||
                  S[s[0]] instanceof Boolean ||
                  (S[s[0]] = new Boolean(S[s[0]])),
                (S[s[0]][s[1]] = i)),
            w.push((i ? '' : 'no-') + s.join('-'));
      }
  }
  ...
  function f(e, n, r, i) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (s = u('div')), (s.id = i ? i[r] : f + (r + 1)), d.appendChild(s);
    return (
      (o = u('style')),
      (o.type = 'text/css'),
      (o.id = 's' + f),
      ...
      (a = n(d, e)),
      p.fake
        ? (p.parentNode.removeChild(p), (C.style.overflow = l), C.offsetHeight)
  ...
  function h(e, t, i, o) {
    ...
    for (var c, f, d, h, g, v = ['modernizr', 'tspan']; !_.style; )
      (c = !0), (_.modElem = u(v.shift())), (_.style = _.modElem.style);
  ...
  function g(e, t, n) {
    ...
    for (var o in e)
      if (e[o] in t)
        return n === !1
          ? e[o]
          : ((i = t[e[o]]), r(i, 'function') ? s(i, n || t) : i);
    return !1;
  }
      ...
      function a(e, n, r) {
        ...
        return (
          (i = r.cache[e]
            ...
            : r.createElem(e)),
          !i.canHaveChildren || x.test(e) || i.tagUrn
            ? i
      ...
      function f(e) {
        for (
          var t,
            n = e.attributes,
            r = n.length,
            i = e.ownerDocument.createElement(N + ':' + e.nodeName);
          r--;
  ...
  $
    ? S.addTest('fontface', !1)
    : k('@font-face {font-family:"font";src:url("https://")}', function(e, n) {
  ...
  S.addTest('supports', R || F),
    ...
    S.addTest('json', 'JSON' in e && 'parse' in JSON && 'stringify' in JSON),
    S.addTest('checked', function() {
      return k(
    ...
    S.addTest('contains', r(String.prototype.contains, 'function')),
    i(),
    o(w),
    delete E.addTest,
      ...
      var a,
        ...
        x = function() {
          ...
          return (
            ...
            n ||
              ((n = o = u.createElement('body')),
              (n.style.background = 'none')),
            (c.style.fontSize = '100%'),
            (n.style.fontSize = '100%'),
            n.appendChild(t),
            o && c.insertBefore(n, c.firstChild),
            (e = t.offsetWidth),
            o ? c.removeChild(n) : n.removeChild(t),
            (c.style.fontSize = r),
        ...
        E = function(t) {
          var n = 'clientWidth',
            ...
            v = new Date().getTime();
          if (t && a && h > v - a)
            return e.clearTimeout(s), void (s = e.setTimeout(E, h));
          a = v;
          for (var S in f)
            if (f.hasOwnProperty(S)) {
              var b = f[S],
                ...
                N = null === C,
                _ = 'em';
              w && (w = parseFloat(w) * (w.indexOf(_) > -1 ? l || x() : 1)),
                C && (C = parseFloat(C) * (C.indexOf(_) > -1 ? l || x() : 1)),
                (b.hasquery &&
                  ((T && N) || !(T || i >= w) || !(N || C >= i))) ||
                  (o[b.media] || (o[b.media] = []),
                  o[b.media].push(d[b.rules]));
            }
          for (var z in p)
            p.hasOwnProperty(z) &&
              p[z] &&
          ...
          for (var k in o)
            if (o.hasOwnProperty(k)) {
              ...
              ($.type = 'text/css'),
                ($.media = k),
                g.insertBefore($, m.nextSibling),
                $.styleSheet
                  ? ($.styleSheet.cssText = j)
                  : $.appendChild(u.createTextNode(j)),
                p.push($);
            }
        },
        S = function(e, t, r) {
          ...
          for (var l = 0; o > l; l++) {
            ...
            s
              ? ((u = r), d.push(a(e)))
              : ((u = i[l].match(n.regex.findStyles) && RegExp.$1),
                d.push(RegExp.$2 && a(RegExp.$2))),
              (p = u.split(',')),
              (m = p.length);
            for (var h = 0; m > h; h++)
              (c = p[h]),
                f.push({
                  media:
                    (c.split('(')[0].match(n.regex.only) && RegExp.$2) || 'all',
                  rules: d.length - 1,
                  hasquery: c.indexOf('(') > -1,
                  minw:
                    c.match(n.regex.minw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ''),
                  maxw:
                    c.match(n.regex.maxw) &&
                    parseFloat(RegExp.$1) + (RegExp.$2 || ''),
                });
          }
          E();
          ...
          for (var t = 0; t < y.length; t++) {
            ...
            i &&
              ...
              (n.styleSheet && n.styleSheet.rawCssText
                ? (S(n.styleSheet.rawCssText, i, o), (m[i] = !0))
                : ((!/^([a-zA-Z:]*\/\/)/.test(i) && !v) ||
