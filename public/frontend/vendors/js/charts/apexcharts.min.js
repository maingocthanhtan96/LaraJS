            ...
            value: function() {
              ...
              (t.globals.animationEnded = !0),
                'function' == typeof t.config.chart.events.animationEnd &&
                  t.config.chart.events.animationEnd(this.ctx, t);
            },
          },
          {
            key: 'morphSVG',
                  ...
                  .afterAll(function() {
                    d.isNumber(e)
                      ? e ===
                        ...
                        o.animationCompleted()
                      : l.globals.shouldAnimate && o.animationCompleted(),
            ...
            value: function(t) {
              ...
              if (d.globals.isXNumeric) {
                ...
                d.globals.seriesX[g].length ||
                  (v = d.globals.maxValsInArrayIndex),
                  (m =
                    (i =
                      (d.globals.seriesX[v][p] - d.globals.minX) /
                      this.xRatio) +
                    o * this.visibleI -
                    (o * this.seriesLen) / 2);
              }
    ...
    I = (function() {
      function t(i) {
        ...
        (this.lineColorArr =
          ...
          void 0 !== s.config.plotOptions.pie.size &&
            (s.globals.radialSize = s.config.plotOptions.pie.size),
          (this.donutSize =
            (s.globals.radialSize *
              parseInt(s.config.plotOptions.pie.donut.size)) /
            100),
          (this.sliceLabels = []),
          ...
          },
          {
            ...
            value: function(t) {
              ...
              for (
                ...
                var P = L - w,
                  M = Array.isArray(e.config.stroke.dashArray)
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function(t) {
              ...
              if (
                ((e = s.e.clientY - l.top - s.tooltipRect.ttHeight / 2),
            ...
            value: function(t, e, i, s, a) {
              ...
              if (r.config.legend.tooltipHoverFormatter) {
                ...
                for (var u = 0; u < d.length; u++) {
                  ...
                  if (n)
                    g.innerHTML =
                      r.globals.collapsedSeriesIndices.indexOf(p) < 0 ? b : x;
        ...
        s(i, [
          {
            ...
            value: function(t) {
              ...
              (this.xyRatios = i),
                ...
                (this.gridRect = s.globals.dom.baseEl.querySelector(
                  '.apexcharts-grid'
                )),
                        ...
                        'mousemove' === t.type || 'touchmove' === t.type
                          ...
                          : (('mouseup' === t.type && 1 === t.which) ||
                            ...
                            ('function' == typeof e.config.chart.events.click &&
                              e.config.chart.events.click(t, i, s),
